          ...
          <form onSubmit={handleSubmit} style={{ maxWidth: '500px', margin: 'auto',marginLeft:'600px' }}>
            <label>
              ...
              <select
                ...
                style={{ width: '150%',height:'50px', padding: '10px', marginBottom: '15px', borderRadius: '11px', border: '3px solid black' }}
              >
            ...
            <label>
              ...
              <input
                ...
                onChange={handleChange}
                required
                style={{ width: '150%',height:'30px', padding: '10px', marginBottom: '15px',borderRadius:'11px', border: '3px solid black' }}
              />
            </label>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <label style={{ width: '30%' }}>
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  style={{ width: '100%',height:'30px', padding: '10px', marginBottom: '15px',borderRadius:'11px', border: '3px solid black' }}
                />
            ...
            <label>
              ...
              <input
                ...
                onChange={handleChange}
                required
                style={{ width: '150%',height:'30px', padding: '10px', marginBottom: '15px' ,display:'flex',borderRadius:'11px', border: '3px solid black'}}
              />
            </label>
            <label>
               Age:
            ...
            <label>
              ...
              <select
                ...
                onChange={handleChange}
                style={{ width: '150%',height:'50px', padding: '10px', marginBottom: '15px' ,borderRadius:'20px', border: '3px solid black'}}
              >
                <option value="">Please Select</option>
                <option value="male">Lower</option>
                <option value="female">Upper</option>
