...
return (
  ...
  <div className="services-container">
    ...
    <div className="services-content">
      <h2>Our Services</h2>
      <p>Welcome to our travel agency. We offer a wide range of services to make your travel experience smooth and enjoyable.</p>
    </div>
    <div className="services-list">
      <div className="service">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSlihKWRu9LoR874HS3dmlMvoBO2WsDIdjWa0I3wQ0S-g&s" alt="Tours" />
        <h3>Tours</h3>
        <p>Explore our exciting tour packages and discover amazing destinations around the world.</p>
      </div>
      <div className="service">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTRNwmQEXV0aIturzMo69Lb7hJrnLGstOsZGw&usqp=CAU" alt="Travel Guides" />
        <h3>Travel Guides</h3>
        <p>Get expert guidance from our travel guides to make the most out of your journey.</p>
      </div>
      <div className="service">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQg8z3DSG7yj1gAt6Nl1TdOu5zoUKGq-2nbebfRyVaMnaPyEFnWyNS8gqeQ0ruCo5lIjHo&usqp=CAU" alt="Flight Booking" />
        <h3>Flight Booking</h3>
        <p>Book your flights hassle-free with our easy-to-use flight booking system.</p>
      </div>
      <div className="service">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ547pAGc95w0ztQd7jvL6atXsyLn5Ed6nkiKDP3XDrCQ&s" alt="Train Booking" />
        <h3>Train Booking</h3>
        <p>Travel conveniently by booking your train tickets through our platform.</p>
      </div>
    </div>
  </div>
  <Footer/>
